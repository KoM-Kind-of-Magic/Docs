...
ALTER TABLE `deck` ADD FOREIGN KEY (`representing_card_uuid`) REFERENCES `card` (`uuid`);

ALTER TABLE `user_card` ADD FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`);

ALTER TABLE `user_card` ADD FOREIGN KEY (`uuid`) REFERENCES `card` (`uuid`);

ALTER TABLE `card_deck` ADD FOREIGN KEY (`deck_id`) REFERENCES `deck` (`deck_id`);

ALTER TABLE `card_deck` ADD FOREIGN KEY (`uuid`) REFERENCES `card` (`uuid`);
